...
public class LoginUser {
    ...
    public static final Target INPUT_CORREO= Target.the("campo de  correo").located(By.name("email"));
    public static final Target INPUT_PASSWORD= Target.the("campo de  contraseña").located(By.name("password"));
    public static final Target BUTTON_LOGUEARSE= Target.the("hace clic en el boton de loguearse").locatedBy("button[data-qa='login-button']");
