...
public class RegistroUser {
    ...
    public static final Target INPUT_CORREO_REGISTED = Target.the("campo correo para registrar nuevo usuario").located(By.name("email"));
    public static final Target BUTTON_INCRIBIRSE = Target.the("hace clic en el boton de registrarse").locatedBy("button[data-qa='lsignup-button']");
    public static final Target TITLE_INGRESAR_INFORMACION = Target.the("Titulo apra loguearse").locatedBy("//h2[contains('Enter Account Information')]");
    ...
    public static final Target TITLE_DIRECCION = Target.the("Titulo para dirección").locatedBy("//h2[contains(text(),'Address Information')]");
